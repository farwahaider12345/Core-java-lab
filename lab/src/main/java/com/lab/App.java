...
public class App {
	public static void main(String[] args) {
		...
		student4.setStudentDetail(studentdetail4);
		...
		// Delete method
		Student student = studentDao.deleteStudent(student1.getStudentDetail());
		System.out.println("STUDENT DELELTED : " + student.getFirstName());
